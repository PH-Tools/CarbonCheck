...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_5.addWidget(self.lineEdit_selectSourcePHPPforBaseliner)
        ...
        self.horizontalLayout_5.addWidget(self.btn_selectSourcePHPPforBaseliner)
        ...
        self.comboBox_projBaselineCode = QtWidgets.QComboBox(parent=self.frame_5)
        self.comboBox_projBaselineCode.setObjectName("comboBox_projBaselineCode")
        self.horizontalLayout_7.addWidget(self.comboBox_projBaselineCode)
        ...
        self.horizontalLayout_8.addWidget(self.label_13, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        self.comboBox_projUseGroup = QtWidgets.QComboBox(parent=self.frame_11)
        self.comboBox_projUseGroup.setFrame(True)
        self.comboBox_projUseGroup.setObjectName("comboBox_projUseGroup")
        self.horizontalLayout_8.addWidget(self.comboBox_projUseGroup)
        ...
        self.horizontalLayout_2.addWidget(self.comboBox_projASHRAEClimateZone)
        ...
        self.comboBox_projPFGroup = QtWidgets.QComboBox(parent=self.frame_12)
        self.comboBox_projPFGroup.setObjectName("comboBox_projPFGroup")
        self.horizontalLayout_9.addWidget(self.comboBox_projPFGroup)
        ...
        self.gridLayout.addWidget(self.checkBox_baseliner_setEnvelopeUValues, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_baseliner_setWindowUValues, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_baseliner_setWindowAreas, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_baseliner_setSkylightAreas, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_baseliner_setSpaceLightingLPD, 4, 0, 1, 1)
        ...
        self.verticalLayout_4.addWidget(self.btn_writeBaselinePHPP)
        ...
        self.gridLayout_3.addWidget(self.line_edit_project_name, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.tree_view_team_info, 1, 2, 2, 1)
        self.clientNameLabel = QtWidgets.QLabel(parent=self.frame)
        self.clientNameLabel.setObjectName("clientNameLabel")
        self.gridLayout_3.addWidget(self.clientNameLabel, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_edit_client_name, 2, 1, 1, 1)
        self.btn_add_team_info = QtWidgets.QPushButton(parent=self.frame)
        self.btn_add_team_info.setObjectName("btn_add_team_info")
        self.gridLayout_3.addWidget(self.btn_add_team_info, 3, 2, 1, 1)
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.groupBox_Bldg_Data)
        ...
        self.gridLayout_2.addWidget(self.tree_view_baseline, 1, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.tree_view_proposed, 1, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.btn_add_baseline_seg, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_del_baseline_seg, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_add_proposed_seg, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_del_proposed_seg, 2, 3, 1, 1)
        ...
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.frame_create_report)
        ...
        self.horizontalLayout_3.addWidget(self.btn_create_report)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 944, 37))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "Basleine Code:"))
