...
PDFReader.register_pdf_section_class(WufiPDF_AnnualHeatingAndCoolingDemand)
PDFReader.register_pdf_section_class(WufiPDF_Areas)
PDFReader.register_pdf_section_class(WufiPDF_AssemblyAndWindowTypes)
PDFReader.register_pdf_section_class(WufiPDF_AuxElectricity)
PDFReader.register_pdf_section_class(WufiPDF_BuildingInformation)
PDFReader.register_pdf_section_class(WufiPDF_BuildingElements)
PDFReader.register_pdf_section_class(WufiPDF_CalculationParameters)
PDFReader.register_pdf_section_class(WufiPDF_ClimateSummary)
PDFReader.register_pdf_section_class(WufiPDF_ClimateDetailed)
PDFReader.register_pdf_section_class(WufiPDF_DHWandDistribution)
PDFReader.register_pdf_section_class(WufiPDF_EnvelopeSummary)
PDFReader.register_pdf_section_class(WufiPDF_HeatingSeasonHeatFlows)
PDFReader.register_pdf_section_class(WufiPDF_HVAC)
PDFReader.register_pdf_section_class(WufiPdf_InternalGains)
PDFReader.register_pdf_section_class(WufiPDF_PeakHeatingAndCoolingLoad)
PDFReader.register_pdf_section_class(WufiPDF_PassiveHouseData)
PDFReader.register_pdf_section_class(WufiPDF_PHRecommendations)
PDFReader.register_pdf_section_class(WufiPDF_PHRequirements)
PDFReader.register_pdf_section_class(WufiPDF_ProjectData)
PDFReader.register_pdf_section_class(WufiPDF_ResidentialElectric)
PDFReader.register_pdf_section_class(WufiPDF_Results)
PDFReader.register_pdf_section_class(WufiPDF_SiteEnergyMonthly)
PDFReader.register_pdf_section_class(WufiPDF_PropertySite)
PDFReader.register_pdf_section_class(WufiPDF_SpecificMonthlyDemand)
PDFReader.register_pdf_section_class(WufiPDF_ThermalBridges)
PDFReader.register_pdf_section_class(WufiPDF_Ventilation)
PDFReader.register_pdf_section_class(WufiPDF_Windows)
PDFReader.register_pdf_section_class(WufiPDF_ZonesAndComponents)
