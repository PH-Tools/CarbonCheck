...
from NBDM.from_WUFI_PDF.pdf_sections.annual_demand import (
    AnnualHeatingAndCoolingDemand,
    AnnualDemand,
)
from NBDM.from_WUFI_PDF.pdf_sections.peak_load import PeakHeatingAndCoolingLoad, PeakLoad


def build_NBDM_siteEnergyFromWufiPDF() -> NBDM_SiteEnergy:
...
def build_NBDM_performanceFromWufiPDF(
    ...
    demand_section: AnnualHeatingAndCoolingDemand = _pdf_data[
        AnnualHeatingAndCoolingDemand.__pdf_heading_string__
    ]  # type: ignore
    load_section: PeakHeatingAndCoolingLoad = _pdf_data[
        PeakHeatingAndCoolingLoad.__pdf_heading_string__
    ]  # type: ignore

    # -- Build up the performance object
    site_energy = build_NBDM_siteEnergyFromWufiPDF()
