...
reader = PDFReader()
file_path = Path("tests/_source_pdf/ridgeway_baseline.pdf")
...
new_project.heating_systems = create_NBDM_Heating_Systems_from_WufiPDF(
    reader.pdf_sections
)
...
print(new_project.heating_systems)
