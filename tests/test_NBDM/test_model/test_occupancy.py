...
def test_building_segment_occupancy(sample_NBDM_BuildingSegmentOccupancy):
    assert sample_NBDM_BuildingSegmentOccupancy

def test_building_segment_geometry_to_dict(sample_NBDM_BuildingSegmentOccupancy: NBDM_BuildingSegmentOccupancy):
